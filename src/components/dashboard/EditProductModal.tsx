          ...
          <Typography id="keep-mounted-modal-description" sx={{ mt: 2 }}>
            <div className='text-black text-base text-right px-10 sm:mt-6 pb-10  '>
              <div className='flex justify-between'>
                <h2 className='text-xl mb-6'>    ویرایش محصول</h2>
                    ...
                    {showImage &&
                      <div className="">
                        <div className="mb-5 w-full flex items-center">
                          ...
                          {selectedImageDetails &&
                            <div className=''>
                              ...
                              />
                              <button className='text-blue-600 mt-2 text-[13px]' onClick={() => setSelectedImageDetails(null)}
                              >حذف عکس</button>
                            </div>}
                        </div >
                        <button type="button" onClick={() => {
                          ...
                          // sendDetailsforImage() 
                          //  sendImgDetail()
                        }} className=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 text-center   mb-6 w-32"
                        >ثبت عکس</button>
                      </div>
                    }
                  </div>
