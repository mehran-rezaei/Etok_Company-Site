...
import { addBlog, addimage, getBlogTypeGroup, getSubBlogTypeGroup, getSubBlogTypeGroupByBLogTypeId } from '@/DataService/blog/blogProvider';
...
const AddPost = () => {
  ...
  useEffect(() => {
    if (idForDetail) {
      addimage(idForDetail, formDataMain)
        // axios.post(`https://etokweb.etokco.ir/Image/AddImage?Id=${idForDetail}`,formDataMain,{
        // })
        .then(Response => {
          console.log(Response);
          if (Response.data.isSuccess === true) {
  ...
  useEffect(() => {
    ...
    ///////////////////////////////////////////////////////////
    // getSubBlogTypeGroup()
    getSubBlogTypeGroupByBLogTypeId(data.blogTypeGroupId)
      .then(response => {
        console.log(response.data.dataList);
      ...
      <div >
        <div className='flex justify-between w-full'>
          <div className='w-full'>
            {typeBlog ?
              <button onClick={() => setShowBlogTypes(!showBlogTypes)} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-1/3 mb-4" type="button">
                {typeBlog.typeName}<svg className="w-4 h-4 mr-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
              :
              <button onClick={() => setShowBlogTypes(!showBlogTypes)} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-1/3 mb-4" type="button"
              >نوع بلاگ<svg className="w-4 h-4 mr-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
            }
              ...
              <ul className="py-2 text-sm  text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                {blogTypes && blogTypes.map((type: any) => (
                  <li onClick={() => {
                    ...
                    setTypeBlog(type)
                    setData({ ...data, blogTypeGroupId: type.id })
          ...
          <div className='w-full '>
            ...
            {typeSubBlog ?
              <button onClick={() => setSubShowBlogTypes(!showSubBlogTypes)} id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-1/3 mb-4" type="button">
                {typeSubBlog.subBlogTypeName}<svg className="w-4 h-4 mr-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
              :
              <button 
              ...
              <ul className="py-2 text-sm  text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                {subblogTypes && subblogTypes.map((type: any) => (
                  <li onClick={() => {
                    ...
                    setTypeSubBlog(type)
                    setData({ ...data, subBlogTypeId: type.id })
                  }} key={type.id} className="block px-4   py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
        ...
        <form>
          ...
          <div className="mb-1 w-full flex items-center justify-center">
            ...
            {selectedImage &&
              <div className=''>
                ...
                <button className='text-blue-600 mt-2 text-[13px]'
          ...
          <button type="button" onClick={sendData} className="text-white w-48 mt-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-9 mb-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >ثبت پست </button>
